...
export default { name: 'opcionescolumna',
  ...
  methods: {
    alternarCategoria(nuevoValor) {
      ...
      toggleCategoria(this.categoriaSeleccionada); this.slateColumnas = obtenerColumnas()
    },
    eliminarSeleccionada() { eliminarColumna(this.categoriaSeleccionada); this.slateColumnas = obtenerColumnas(); this.categoriaSeleccionada = null },
    renombrarSeleccionada() { const vieja = this.categoriaSeleccionada, nueva = this.slateColumnas[vieja].nombre.trim()
